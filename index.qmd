...
📷 **IMAGEN PENDIENTE**: Banner del programa AcademIA HackLab con los
logos de las instituciones aliadas (UAI, Fundación Ciudad Emergente,
Google, Axmos, CINNDA, Gobierno Regional Metropolitano) y una imagen de
fondo de la Región Metropolitana de Santiago.
:::
...
herramientas del ecosistema Google:

| Herramienta | Rol en el curso | Requiere instalación |
|----|----|----|
| **Antigravity (IDE)** | Entorno principal de vibe coding, con selección de modelos Google (Gemini Flash / Gemini Pro) según complejidad de la tarea | Sí (guiada en la Sesión 2.2) |
| **Gemini (app / AI Studio)** | Asistente conversacional para prompting, exploración de ideas y análisis de texto | No (navegador) |
| **Google Colab** | Ejecución de notebooks Python sin instalar nada; respaldo cuando Antigravity no esté disponible | No (navegador) |
| **Google My Maps / Sheets** | Visualización y organización de datos sin código | No (navegador) |
| **Google Cloud** | APIs de IA (NLP, análisis de sentimientos) para el Módulo 2, con los créditos del curso | No (navegador) |

::: callout-important
Antes de la Sesión 2.2 cada participante debe contar con cuenta Google
activa, créditos de Google Cloud asignados y Antigravity instalado o,
en su defecto, acceso verificado a Google Colab. La guía de preparación
se envía una semana antes.
:::
...
| M2: Modelos IA | 5.1 | Sensores ciudadanos e IoT aplicados al urbanismo táctico | 1,5 | Presencial |
| M2: Modelos IA | 5.2 | Procesamiento de Lenguaje Natural (NLP) para la participación comunitaria | 1,5 | Presencial |
...
pegar en Antigravity, Gemini o Colab. La invitación permanente es una
sola: **reemplaza la comuna de ejemplo por la tuya**. Tu conocimiento
del territorio es el insumo más valioso del curso; la IA solo lo
amplifica.
